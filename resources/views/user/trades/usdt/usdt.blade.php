...
<div class="col-12">
    ...
    <div class="box-body">
        ...
        <form class="rd-mailform" method="POST" action="{{ route('store-usdt') }}" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
                <div class="col-12">
                    <div class="form-group">
                     ...
                     <textarea class="form-control" id="amount3" cols="10" rows="2" name="amount"  placeholder="0.00" required onkeyup="calculate()" onkeyup="show()"></textarea>
                    </div></div>
                    </div>
    ...
    <div class="form-group">
     ...
     <input type="number" name="rate" id="rate3" class="form-control" value="{{ $wallet->usdt_rate }}" readonly>
    ...
    <div class="col-12">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <div class="input-group-prepend">
                 <div class="input-group-text" id="p"><i class="cc USDT" title="USDT"></i></div>
                </div>
        <textarea  cols="10" rows="2" class="form-control" id="wallet"  readonly>{{ $wallet->usdt_address }}</textarea>
        </div>
